...
params = {'data': {'data': {'signals': ['LFP_BIP7','LFP_BIP8','LFP_BIP9','LFP_BIP10','LFP_BIP11','LFP_BIP12'], 'time': 'LFP_time', 'fs': 'LFP_Fs'}},
          'event': {'RFS' : {'signals': TARGET_NAME, 'kind': 'array'}}}
...
CLEANING_OPT = {'combine_fields': {'fields': CHANNELS, 'method': 'subtract', 'remove_selected_fields': True, 'save_to_params': 'data'},
                'remove_artefacts': {'params': 'params/data/data', 'method': 'amplitude', 'threshold': 30, 'signal_n': 1}}
# CLEANING_OPT = {'combine_fields': {'fields': CHANNELS, 'method': 'subtract', 'remove_selected_fields': True, 'save_to_params': 'data'}}

td = cleaning_pipeline(td,**CLEANING_OPT)

# td_plot(td[0], y = ['LFP_BIP7-LFP_BIP8', 'LFP_BIP8-LFP_BIP9', 'LFP_BIP10-LFP_BIP11', 'LFP_BIP11-LFP_BIP12'], x = 'LFP_time')
#%% PREPROCESS DATA
